...
// Function to check if a file is a library(1) file
function isComponent(file, callback) {
  fs.readFile(file, function (err, contents) {
    ...
    // Attempt to find specific things from the library(1) spec
    ...
    // If none were found, than it's a valid library.json ano file
